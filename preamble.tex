...
\usepackage{graphicx}
\graphicspath{%
    {images/terms-of-reference}
    {images/components-search}
    {images/parts-design}
    {images/RF-design}
}
...
\hypersetup{%
    ...
    filecolor=magenta,
    urlcolor=cyan,
    pdftitle={Большое домашнее задание по курсу <<Проектирование приёмо-передающих устройств в среде Keysight ADS>>},
    bookmarks=true,
